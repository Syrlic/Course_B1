 ...
 * 2019-03-10T14:03:44.657+04:00
 * Generated source version: 3.3.1
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:src/test/resources/ipservice.xml",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/test/resources/ipservice.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:src/test/resources/ipservice.xml");
        }
        WSDL_LOCATION = url;
    }
